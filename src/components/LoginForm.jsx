...
const LoginForm = () => {
  ...
  return (
    <div className="w-full flex justify-center font-JF sm:px-4">
      <div className="flex flex-col lg:min-w-[385px] mx-4 lg:w-[40%] md:w-[40%] sm:w-full sm:min-w-full rounded-md bg-white items-center">
